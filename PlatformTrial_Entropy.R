...
trialSimEntropy = function(txEffects, sigma2, arms, NperInterim, maxSample, 
...
###############################################################################
    ...
    model_filename = paste("JAGSmodel_EB_", trialName, "_Outcome", outcomeDesign, 
                           ".txt", sep="")
    sink(model_filename)
    cat("
          model{
